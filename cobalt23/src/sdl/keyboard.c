...
void pushkeymod(lua_State *L, uint16_t mod) {
  lua_newtable(L);
  lua_pushboolean(L, mod == KMOD_NONE);
  lua_setfield(L, -2, "none");
  lua_pushboolean(L, mod & KMOD_LSHIFT);
  lua_setfield(L, -2, "lshift");
  lua_pushboolean(L, mod & KMOD_RSHIFT);
  lua_setfield(L, -2, "rshift");
  lua_pushboolean(L, mod & KMOD_SHIFT);
  lua_setfield(L, -2, "shift");
  lua_pushboolean(L, mod & KMOD_LCTRL);
  lua_setfield(L, -2, "lctrl");
  lua_pushboolean(L, mod & KMOD_RCTRL);
  lua_setfield(L, -2, "rctrl");
  lua_pushboolean(L, mod & KMOD_CTRL);
  lua_setfield(L, -2, "ctrl");
  lua_pushboolean(L, mod & KMOD_LALT);
  lua_setfield(L, -2, "lalt");
  lua_pushboolean(L, mod & KMOD_RALT);
  lua_setfield(L, -2, "ralt");
  lua_pushboolean(L, mod & KMOD_ALT);
  lua_setfield(L, -2, "alt");
  lua_pushboolean(L, mod & KMOD_LGUI);
  lua_setfield(L, -2, "lgui");
  lua_pushboolean(L, mod & KMOD_RGUI);
  lua_setfield(L, -2, "rgui");
  lua_pushboolean(L, mod & KMOD_GUI);
  lua_setfield(L, -2, "gui");
  lua_pushboolean(L, mod & KMOD_NUM);
  lua_setfield(L, -2, "num");
  lua_pushboolean(L, mod & KMOD_CAPS);
  lua_setfield(L, -2, "caps");
  lua_pushboolean(L, mod & KMOD_MODE);
  lua_setfield(L, -2, "mode");
  lua_pushboolean(L, mod & KMOD_SCROLL);
...
#define ADD(what)                          \
  do {                                     \
    lua_pushinteger(L, SDLK_##what);       \
    lua_setfield(L, -2, "KEYCODE_" #what); \
  } while (0)
  ADD(UNKNOWN);
  ADD(RETURN);
  ADD(ESCAPE);
...
#define ADD(what)                            \
  do {                                       \
    lua_pushinteger(L, SDL_SCANCODE_##what); \
    lua_setfield(L, -2, "SCANCODE_" #what);  \
  } while (0)
  ADD(UNKNOWN);
  ADD(A);
  ADD(B);
