...
static void Callback(void *usrdata, const char *name, const char *oldval,
                     const char *newval) {
  int top, rc;
...
static const struct luaL_Reg Methods[] = {
    {"del", Destroy}, {NULL, NULL} /* sentinel */
};
...
static const struct luaL_Reg Functions[] = {
    {"add_hint_callback", Create}, {"set_hint", SetHint},
    {"get_hint", GetHint},         {"reset_hint", ResetHint},
    {"reset_hints", ResetHints},   {NULL, NULL} /* sentinel */
};
