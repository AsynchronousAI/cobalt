...
OPT_ENTRY(redir_protocols, REDIR_PROTOCOLS, LNG, 0,
          CURLPROTO_ALL) /*! @fixme All protocols except for FILE and SCP */
...
OPT_ENTRY(socks5_gssapi_nec, SOCKS5_GSSAPI_NEC, LNG, 0,
          LCURL_DEFAULT_VALUE) /*! @check doc says nothing */
...
OPT_ENTRY(mail_from, MAIL_FROM, STR, LCURL_STORE_STRING,
          LCURL_DEFAULT_VALUE) /*! @check doc says `blank` */
...
OPT_ENTRY(ftp_response_timeout, FTP_RESPONSE_TIMEOUT, LNG, 0,
          LCURL_DEFAULT_VALUE) /*! @fixme doc says `None` */
OPT_ENTRY(ftp_alternative_to_user, FTP_ALTERNATIVE_TO_USER, STR,
          LCURL_STORE_STRING, LCURL_DEFAULT_VALUE)
...
OPT_ENTRY(infilesize, INFILESIZE, LNG, 0,
          LCURL_DEFAULT_VALUE) /*! @fixme doc says `Unset` */
...
OPT_ENTRY(cainfo, CAINFO, STR, LCURL_STORE_STRING,
          LCURL_DEFAULT_VALUE) /*! @fixme doc says `Built-in system specific` */
...
OPT_ENTRY(rtsp_session_id, RTSP_SESSION_ID, STR, LCURL_STORE_STRING,
          LCURL_DEFAULT_VALUE)
OPT_ENTRY(rtsp_stream_uri, RTSP_STREAM_URI, STR, LCURL_STORE_STRING,
          LCURL_DEFAULT_VALUE)
OPT_ENTRY(rtsp_transport, RTSP_TRANSPORT, STR, LCURL_STORE_STRING,
          LCURL_DEFAULT_VALUE)
#endif

#if LCURL_CURL_VER_GE(7, 22, 0)
OPT_ENTRY(gssapi_delegation, GSSAPI_DELEGATION, LNG, 0,
...
OPT_ENTRY(keep_sending_on_error, KEEP_SENDING_ON_ERROR, LNG, 0,
          LCURL_DEFAULT_VALUE)
#endif
...
OPT_ENTRY(proxy_tlsauth_username, PROXY_TLSAUTH_USERNAME, STR, 0,
          LCURL_DEFAULT_VALUE)
OPT_ENTRY(proxy_tlsauth_password, PROXY_TLSAUTH_PASSWORD, STR, 0,
          LCURL_DEFAULT_VALUE)
...
OPT_ENTRY(proxy_sslkeytype, PROXY_SSLKEYTYPE, STR, 0,
          "PEM") /* default value not defined. Use same as for `SSLKEYTYPE` */
OPT_ENTRY(proxy_keypasswd, PROXY_KEYPASSWD, STR, 0, LCURL_DEFAULT_VALUE)
OPT_ENTRY(proxy_ssl_cipher_list, PROXY_SSL_CIPHER_LIST, STR, 0,
          LCURL_DEFAULT_VALUE)
...
OPT_ENTRY(proxy_pinnedpublickey, PROXY_PINNEDPUBLICKEY, STR, 0,
          LCURL_DEFAULT_VALUE)
#endif

#if LCURL_CURL_VER_GE(7, 53, 0)
OPT_ENTRY(abstract_unix_socket, ABSTRACT_UNIX_SOCKET, STR, 0,
          LCURL_DEFAULT_VALUE)
#endif

#if LCURL_CURL_VER_GE(7, 54, 0)
OPT_ENTRY(suppress_connect_headers, SUPPRESS_CONNECT_HEADERS, LNG, 0,
          LCURL_DEFAULT_VALUE)
#endif
...
OPT_ENTRY(happy_eyeballs_timeout_ms, HAPPY_EYEBALLS_TIMEOUT_MS, LNG, 0,
          CURL_HET_DEFAULT)
OPT_ENTRY(timevalue_large, TIMEVALUE_LARGE, OFF, 0, LCURL_DEFAULT_VALUE)
#endif

#if LCURL_CURL_VER_GE(7, 60, 0)
OPT_ENTRY(dns_shuffle_addresses, DNS_SHUFFLE_ADDRESSES, LNG, 0,
          LCURL_DEFAULT_VALUE)
OPT_ENTRY(haproxyprotocol, HAPROXYPROTOCOL, LNG, 0, LCURL_DEFAULT_VALUE)
#endif

#if LCURL_CURL_VER_GE(7, 61, 0)
OPT_ENTRY(disallow_username_in_url, DISALLOW_USERNAME_IN_URL, LNG, 0,
          LCURL_DEFAULT_VALUE)
...
OPT_ENTRY(upkeep_interval_ms, UPKEEP_INTERVAL_MS, LNG, 0,
          CURL_UPKEEP_INTERVAL_DEFAULT)
OPT_ENTRY(doh_url, DOH_URL, STR, 0, LCURL_DEFAULT_VALUE)
// thre no named value for default value. It just defined as 64kB in
// documentation
