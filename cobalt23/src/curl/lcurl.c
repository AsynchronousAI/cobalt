...
static void lcurl_easy_option_push(lua_State *L,
                                   const struct curl_easyoption *opt) {
  lua_newtable(L);
  lua_pushliteral(L, "id");
  lutil_pushuint(L, opt->id);
  lua_rawset(L, -3);
  lua_pushliteral(L, "name");
  lua_pushstring(L, opt->name);
  lua_rawset(L, -3);
  lua_pushliteral(L, "type");
  lutil_pushuint(L, opt->type);
  lua_rawset(L, -3);
  lua_pushliteral(L, "flags");
  lutil_pushuint(L, opt->flags);
  lua_rawset(L, -3);
  lua_pushliteral(L, "flags_set");
  lua_newtable(L);
  lua_pushliteral(L, "alias");
  lua_pushboolean(L, opt->flags & CURLOT_FLAG_ALIAS);
  lua_rawset(L, -3);
  lua_rawset(L, -3);
  ...
  switch (opt->type) {
    ...
    case CURLOT_STRING:
      ...
      break;
    case CURLOT_SLIST:
      lua_pushliteral(L, "SLIST");
      break;
    case CURLOT_CBPTR:
      lua_pushliteral(L, "CBPTR");
      break;
    case CURLOT_BLOB:
...
static int lcurl_version_info(lua_State *L) {
  ...
  lua_setfield(L, -2, "version"); /* LIBCURL_VERSION     */
  lutil_pushuint(L, data->version_num);
  lua_setfield(L, -2, "version_num"); /* LIBCURL_VERSION_NUM */
  lua_pushstring(L, data->host);
  lua_setfield(L, -2, "host"); /* OS/host/cpu/machine when configured */

  lua_newtable(L);
  lua_pushliteral(L, "IPV6");
  lua_pushboolean(L, data->features & CURL_VERSION_IPV6);
  lua_rawset(L, -3);
  lua_pushliteral(L, "KERBEROS4");
  lua_pushboolean(L, data->features & CURL_VERSION_KERBEROS4);
  lua_rawset(L, -3);
  lua_pushliteral(L, "SSL");
  lua_pushboolean(L, data->features & CURL_VERSION_SSL);
  lua_rawset(L, -3);
  lua_pushliteral(L, "LIBZ");
  lua_pushboolean(L, data->features & CURL_VERSION_LIBZ);
  lua_rawset(L, -3);
  lua_pushliteral(L, "NTLM");
  lua_pushboolean(L, data->features & CURL_VERSION_NTLM);
  lua_rawset(L, -3);
  lua_pushliteral(L, "GSSNEGOTIATE");
  lua_pushboolean(L, data->features & CURL_VERSION_GSSNEGOTIATE);
  lua_rawset(L, -3);
#if LCURL_CURL_VER_GE(7, 38, 0)
  lua_pushliteral(L, "GSSAPI");
  lua_pushboolean(L, data->features & CURL_VERSION_GSSAPI);
  lua_rawset(L, -3);
#endif
  lua_pushliteral(L, "DEBUG");
  lua_pushboolean(L, data->features & CURL_VERSION_DEBUG);
  lua_rawset(L, -3);
  lua_pushliteral(L, "ASYNCHDNS");
  lua_pushboolean(L, data->features & CURL_VERSION_ASYNCHDNS);
  lua_rawset(L, -3);
  lua_pushliteral(L, "SPNEGO");
  lua_pushboolean(L, data->features & CURL_VERSION_SPNEGO);
  lua_rawset(L, -3);
  lua_pushliteral(L, "LARGEFILE");
  lua_pushboolean(L, data->features & CURL_VERSION_LARGEFILE);
  lua_rawset(L, -3);
  lua_pushliteral(L, "IDN");
  lua_pushboolean(L, data->features & CURL_VERSION_IDN);
  lua_rawset(L, -3);
  lua_pushliteral(L, "SSPI");
  lua_pushboolean(L, data->features & CURL_VERSION_SSPI);
  lua_rawset(L, -3);
  lua_pushliteral(L, "CONV");
  lua_pushboolean(L, data->features & CURL_VERSION_CONV);
  lua_rawset(L, -3);
  lua_pushliteral(L, "CURLDEBUG");
  lua_pushboolean(L, data->features & CURL_VERSION_CURLDEBUG);
  lua_rawset(L, -3);
#if LCURL_CURL_VER_GE(7, 21, 4)
  lua_pushliteral(L, "TLSAUTH_SRP");
  lua_pushboolean(L, data->features & CURL_VERSION_TLSAUTH_SRP);
  lua_rawset(L, -3);
#endif
#if LCURL_CURL_VER_GE(7, 22, 0)
  lua_pushliteral(L, "NTLM_WB");
  lua_pushboolean(L, data->features & CURL_VERSION_NTLM_WB);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_HTTP2
  lua_pushliteral(L, "HTTP2");
  lua_pushboolean(L, data->features & CURL_VERSION_HTTP2);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_HTTPS_PROXY
  lua_pushliteral(L, "HTTPS_PROXY");
  lua_pushboolean(L, data->features & CURL_VERSION_HTTPS_PROXY);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_MULTI_SSL
  lua_pushliteral(L, "MULTI_SSL");
  lua_pushboolean(L, data->features & CURL_VERSION_MULTI_SSL);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_BROTLI
  lua_pushliteral(L, "BROTLI");
  lua_pushboolean(L, data->features & CURL_VERSION_BROTLI);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_ALTSVC
  lua_pushliteral(L, "ALTSVC");
  lua_pushboolean(L, data->features & CURL_VERSION_ALTSVC);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_HTTP3
  lua_pushliteral(L, "HTTP3");
  lua_pushboolean(L, data->features & CURL_VERSION_HTTP3);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_ZSTD
  lua_pushliteral(L, "ZSTD");
  lua_pushboolean(L, data->features & CURL_VERSION_ZSTD);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_UNICODE
  lua_pushliteral(L, "UNICODE");
  lua_pushboolean(L, data->features & CURL_VERSION_UNICODE);
  lua_rawset(L, -3);
#endif
#ifdef CURL_VERSION_HSTS
  lua_pushliteral(L, "HSTS");
  lua_pushboolean(L, data->features & CURL_VERSION_HSTS);
  lua_rawset(L, -3);
#endif
  ...
  if (data->ssl_version) {
    lua_pushstring(L, data->ssl_version);
    lua_setfield(L, -2, "ssl_version");
  } /* human readable string */
  lutil_pushuint(L, data->ssl_version_num);
  lua_setfield(L, -2, "ssl_version_num"); /* not used anymore, always 0 */
  if (data->libz_version) {
    lua_pushstring(L, data->libz_version);
    lua_setfield(L, -2, "libz_version");
  } /* human readable string */
  ...
  if (data->age >= CURLVERSION_SECOND) {
    if (data->ares) {
      lua_pushstring(L, data->ares);
      lua_setfield(L, -2, "ares");
    }
    lutil_pushuint(L, data->ares_num);
    lua_setfield(L, -2, "ares_num");
  }

  if (data->age >= CURLVERSION_THIRD) { /* added in 7.12.0 */
    if (data->libidn) {
      lua_pushstring(L, data->libidn);
  ...
  if (data->age >= CURLVERSION_FOURTH) {
    lutil_pushuint(L, data->iconv_ver_num);
    lua_setfield(L, -2, "iconv_ver_num");
    if (data->libssh_version) {
      lua_pushstring(L, data->libssh_version);
      lua_setfield(L, -2, "libssh_version");
    }
  }
#endif
  ...
  if (data->age >= CURLVERSION_FOURTH) {
    lutil_pushuint(L, data->brotli_ver_num);
    lua_setfield(L, -2, "brotli_ver_num");
    if (data->brotli_version) {
      lua_pushstring(L, data->brotli_version);
      lua_setfield(L, -2, "brotli_version");
    }
  }
#endif
  ...
  if (data->age >= CURLVERSION_SIXTH) {
    lutil_pushuint(L, data->nghttp2_ver_num);
    lua_setfield(L, -2, "nghttp2_ver_num");
    if (data->nghttp2_version) {
      lua_pushstring(L, data->nghttp2_version);
      lua_setfield(L, -2, "nghttp2_version");
    }
    if (data->quic_version) {
      lua_pushstring(L, data->quic_version);
      lua_setfield(L, -2, "quic_version");
    }
  }
#endif
  ...
  if (data->age >= CURLVERSION_SEVENTH) {
    if (data->cainfo) {
      lua_pushstring(L, data->cainfo);
      lua_setfield(L, -2, "cainfo");
    }
    if (data->capath) {
      lua_pushstring(L, data->capath);
      lua_setfield(L, -2, "capath");
    }
  }
#endif
  ...
  if (data->age >= CURLVERSION_EIGHTH) {
    lutil_pushuint(L, data->zstd_ver_num);
    lua_setfield(L, -2, "zstd_ver_num");
    if (data->zstd_version) {
      lua_pushstring(L, data->zstd_version);
      lua_setfield(L, -2, "zstd_version");
    }
  }
#endif
...
static int luaopen_lcurl_(lua_State *L, const struct luaL_Reg *func) {
  if (getenv("LCURL_NO_INIT") ==
      NULL) {  // do not initialize curl if env variable LCURL_NO_INIT defined
  ...
  LCURL_PUSH_NUP(L);
  luaL_setfuncs(L, func, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_error_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_hpost_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_easy_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_mime_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_multi_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_share_initlib(L, NUP);
  LCURL_PUSH_NUP(L);
  lcurl_url_initlib(L, NUP);
...
int luaopen_lcurl_safe(lua_State *L) {
  return luaopen_lcurl_(L, lcurl_functions_safe);
}
