...
#if !defined(LUAJIT_cobalt) && !defined(NOLUAJIT_cobalt)
#define LUAJIT_cobalt
#endif
...
#define LUA_RLPATH	";" LUA_RLDIR "?" LUA_SCRIPT_EXT ";" LUA_RLDIR "?/init" LUA_SCRIPT_EXT
...
#define LUA_PATH_DEFAULT	"./?" LUA_SCRIPT_EXT LUA_JPATH LUA_LLPATH LUA_RLPATH
...
#if defined(luajit_c)
#define LUA_PROGNAME	"cobaltJIT"  /* Fallback frontend name. */
