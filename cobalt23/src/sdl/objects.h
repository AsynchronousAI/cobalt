...
#define HOSTMEM_MT "FFTW hostmem"
#define WINDOW_MT "SDL window"
#define SURFACE_MT "SDL surface"
#define PXLFMT_MT "SDL pxlfmt"
#define PALETTE_MT "SDL palette"
#define RENDERER_MT "SDL renderer"
#define TEXTURE_MT "SDL texture"
#define FONT_MT "SDL font"
#define CHUNK_MT "SDL chunk"
#define MUSIC_MT "SDL music"
#define TIMER_MT "SDL timer"
#define GLCONTEXT_MT "SDL glcontext"
#define JOYSTICK_MT "SDL joystick"
#define GAMECONTROLLER_MT "SDL gamecontroller"
#define CURSOR_MT "SDL cursor"
#define SENSOR_MT "SDL sensor"
#define ANIMATION_MT "SDL animation"
#define HINTCB_MT "SDL hintcb"
#define HAPTIC_MT "SDL haptic"
#define MESSAGEBOX_MT "SDL messagebox"
...
struct moonsdl2_ud_s {
  ...
  uint32_t marks;
  int ref1, ref2, ref3, ref4; /* references for callbacks, automatically
                                 unreference at deletion */
  int groupid;
  void *info; /* object specific info (ud_info_t, subject to Free() at
                 destruction, if not NULL) */
};

/* Marks.  m_ = marks word (uint32_t) , i_ = bit number (0 .. 31)  */
#define MarkGet(m_, i_) \
  (((m_) & ((uint32_t)1 << (i_))) == ((uint32_t)1 << (i_)))
...
/* hostmem.c */
#define checkhostmem(L, arg, udp) \
  (hostmem_t *)checkxxx((L), (arg), (udp), HOSTMEM_MT)
#define testhostmem(L, arg, udp) \
  (hostmem_t *)testxxx((L), (arg), (udp), HOSTMEM_MT)
#define opthostmem(L, arg, udp) \
  (hostmem_t *)optxxx((L), (arg), (udp), HOSTMEM_MT)
#define pushhostmem(L, handle) pushxxx((L), (void *)(handle))
#define checkhostmemlist(L, arg, count, err) \
  checkxxxlist((L), (arg), (count), (err), HOSTMEM_MT)

/* window.c */
#define checkwindow(L, arg, udp) \
  (window_t *)checkxxx((L), (arg), (udp), WINDOW_MT)
#define testwindow(L, arg, udp) \
  (window_t *)testxxx((L), (arg), (udp), WINDOW_MT)
...
#define checksurface(L, arg, udp) \
  (surface_t *)checkxxx((L), (arg), (udp), SURFACE_MT)
#define testsurface(L, arg, udp) \
  (surface_t *)testxxx((L), (arg), (udp), SURFACE_MT)
#define optsurface(L, arg, udp) \
  (surface_t *)optxxx((L), (arg), (udp), SURFACE_MT)
#define freesurfacelist freexxxlist
#define checksurfacelist(L, arg, err) \
  checkxxxlist((L), (arg), (err), SURFACE_MT)
...
#define checkpxlfmt(L, arg, udp) \
  (pxlfmt_t *)checkxxx((L), (arg), (udp), PXLFMT_MT)
#define testpxlfmt(L, arg, udp) \
  (pxlfmt_t *)testxxx((L), (arg), (udp), PXLFMT_MT)
...
/* palette.c */
#define checkpalette(L, arg, udp) \
  (palette_t *)checkxxx((L), (arg), (udp), PALETTE_MT)
#define testpalette(L, arg, udp) \
  (palette_t *)testxxx((L), (arg), (udp), PALETTE_MT)
#define optpalette(L, arg, udp) \
  (palette_t *)optxxx((L), (arg), (udp), PALETTE_MT)
#define freepalettelist freexxxlist
#define checkpalettelist(L, arg, err) \
  checkxxxlist((L), (arg), (err), PALETTE_MT)
#define pushpalette(L, handle) pushxxx((L), (void *)(handle))

/* renderer.c */
#define checkrenderer(L, arg, udp) \
  (renderer_t *)checkxxx((L), (arg), (udp), RENDERER_MT)
#define testrenderer(L, arg, udp) \
  (renderer_t *)testxxx((L), (arg), (udp), RENDERER_MT)
#define optrenderer(L, arg, udp) \
  (renderer_t *)optxxx((L), (arg), (udp), RENDERER_MT)
#define freerendererlist freexxxlist
#define checkrendererlist(L, arg, err) \
  checkxxxlist((L), (arg), (err), RENDERER_MT)
...
#define checktexture(L, arg, udp) \
  (texture_t *)checkxxx((L), (arg), (udp), TEXTURE_MT)
#define testtexture(L, arg, udp) \
  (texture_t *)testxxx((L), (arg), (udp), TEXTURE_MT)
#define opttexture(L, arg, udp) \
  (texture_t *)optxxx((L), (arg), (udp), TEXTURE_MT)
#define freetexturelist freexxxlist
#define checktexturelist(L, arg, err) \
  checkxxxlist((L), (arg), (err), TEXTURE_MT)
...
/* glcontext.c */
#define checkglcontext(L, arg, udp) \
  (glcontext_t *)checkxxx((L), (arg), (udp), GLCONTEXT_MT)
#define testglcontext(L, arg, udp) \
  (glcontext_t *)testxxx((L), (arg), (udp), GLCONTEXT_MT)
#define optglcontext(L, arg, udp) \
  (glcontext_t *)optxxx((L), (arg), (udp), GLCONTEXT_MT)
#define freeglcontextlist freexxxlist
#define checkglcontextlist(L, arg, err) \
  checkxxxlist((L), (arg), (err), GLCONTEXT_MT)
...
#define checkjoystick(L, arg, udp) \
  (joystick_t *)checkxxx((L), (arg), (udp), JOYSTICK_MT)
#define testjoystick(L, arg, udp) \
  (joystick_t *)testxxx((L), (arg), (udp), JOYSTICK_MT)
#define optjoystick(L, arg, udp) \
  (joystick_t *)optxxx((L), (arg), (udp), JOYSTICK_MT)
#define freejoysticklist freexxxlist
#define checkjoysticklist(L, arg, err) \
  checkxxxlist((L), (arg), (err), JOYSTICK_MT)
#define pushjoystick(L, handle) pushxxx((L), (void *)(handle))

/* gamecontroller.c */
#define checkgamecontroller(L, arg, udp) \
  (gamecontroller_t *)checkxxx((L), (arg), (udp), GAMECONTROLLER_MT)
#define testgamecontroller(L, arg, udp) \
  (gamecontroller_t *)testxxx((L), (arg), (udp), GAMECONTROLLER_MT)
#define optgamecontroller(L, arg, udp) \
  (gamecontroller_t *)optxxx((L), (arg), (udp), GAMECONTROLLER_MT)
#define freegamecontrollerlist freexxxlist
#define checkgamecontrollerlist(L, arg, err) \
  checkxxxlist((L), (arg), (err), GAMECONTROLLER_MT)
#define pushgamecontroller(L, handle) pushxxx((L), (void *)(handle))

/* cursor.c */
#define checkcursor(L, arg, udp) \
  (cursor_t *)checkxxx((L), (arg), (udp), CURSOR_MT)
#define testcursor(L, arg, udp) \
  (cursor_t *)testxxx((L), (arg), (udp), CURSOR_MT)
...
/* sensor.c */
#define checksensor(L, arg, udp) \
  (sensor_t *)checkxxx((L), (arg), (udp), SENSOR_MT)
#define testsensor(L, arg, udp) \
  (sensor_t *)testxxx((L), (arg), (udp), SENSOR_MT)
...
/* animation.c */
#define checkanimation(L, arg, udp) \
  (animation_t *)checkxxx((L), (arg), (udp), ANIMATION_MT)
#define testanimation(L, arg, udp) \
  (animation_t *)testxxx((L), (arg), (udp), ANIMATION_MT)
#define optanimation(L, arg, udp) \
  (animation_t *)optxxx((L), (arg), (udp), ANIMATION_MT)
#define freeanimationlist freexxxlist
#define checkanimationlist(L, arg, err) \
  checkxxxlist((L), (arg), (err), ANIMATION_MT)
#define pushanimation(L, handle) pushxxx((L), (void *)(handle))

/* hints.c */
#define checkhintcb(L, arg, udp) \
  (hintcb_t *)checkxxx((L), (arg), (udp), HINTCB_MT)
#define testhintcb(L, arg, udp) \
  (hintcb_t *)testxxx((L), (arg), (udp), HINTCB_MT)
...
/* haptic.c */
#define checkhaptic(L, arg, udp) \
  (haptic_t *)checkxxx((L), (arg), (udp), HAPTIC_MT)
#define testhaptic(L, arg, udp) \
  (haptic_t *)testxxx((L), (arg), (udp), HAPTIC_MT)
...
/* messagebox.c */
#define checkmessagebox(L, arg, udp) \
  (messagebox_t *)checkxxx((L), (arg), (udp), MESSAGEBOX_MT)
#define testmessagebox(L, arg, udp) \
  (messagebox_t *)testxxx((L), (arg), (udp), MESSAGEBOX_MT)
#define optmessagebox(L, arg, udp) \
  (messagebox_t *)optxxx((L), (arg), (udp), MESSAGEBOX_MT)
#define freemessageboxlist freexxxlist
#define checkmessageboxlist(L, arg, err) \
  checkxxxlist((L), (arg), (err), MESSAGEBOX_MT)
